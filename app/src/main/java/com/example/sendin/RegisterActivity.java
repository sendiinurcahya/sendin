...
public class RegisterActivity extends AppCompatActivity {
    private EditText editName, editEmail, editNoHp, editPassword, editPasswordConf;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(v -> {
            if (editName.getText().length()>0 && editEmail.getText().length()>0 && editNoHp.getText().length()>0 && editPassword.getText().length()>0 && editPasswordConf.getText().length()>0){
    ...
    public EditText getEditNoHp() {
        return editNoHp;
    }

    public void setEditNoHp(EditText editNoHp) {
        this.editNoHp = editNoHp;
    }
}